...
import org.example.serializer.myCode.MyDecoder;
import org.example.serializer.myCode.MyEncoder;
import org.example.serializer.mySerializer.JsonSerializer;
...
//        pipeline.addLast(new ObjectDecoder(s -> Class.forName(s)));
        ...
        pipeline.addLast(new ReadTimeoutHandler(2, TimeUnit.SECONDS)); // 读超时2秒
        pipeline.addLast(new WriteTimeoutHandler(2, TimeUnit.SECONDS));// 写超时2秒
